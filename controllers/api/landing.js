    ...
    index: async (req, res) => {
        try {
            ...
            const mostPicked = mostPickedData.map(item => {
                ...
                mostPickedItem.imageId.map((item) => {
                    item.imageUrl = res.locals._baseUrl + item.imageUrl
                })
            ...
            const categories = categoryData.map(item => {
                ...
                categoryItem.itemId = categoryItem.itemId.map(itemId => {
                    ...
                    singleItem.imageId.map((item) => {
                        // item.imageUrl = res.locals._baseUrl + item.imageUrl
                        singleItem.imageUrl = res.locals._baseUrl + item.imageUrl
                    })
                    return singleItem;
                });
        ...
        try {
            ...
            items.docs = items.docs.map(item => {
                ...
                singleItem.images.map((item) => {
                    return singleItem.imageUrl = res.locals._baseUrl + item.imageUrl
                })

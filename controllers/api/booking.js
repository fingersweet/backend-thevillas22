        ...
        try {
            ...
            return res.json({
                ...
                item: {
                    ...
                    imageUrl: booking.itemId._id.imageId.map((item) => {
                        return item.imageUrl = res.locals._baseUrl + booking.imageUrl
                    })
                },
            ...
            res.status(201).json({
                ...
                booking: {
                    ...
                    item: {
                        ...
                        imageUrl: resultBooking.itemId._id.imageId.map((item) => {
                        return item.imageUrl = res.locals._baseUrl + booking.imageUrl
                    })
                    },
